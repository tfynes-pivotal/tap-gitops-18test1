...
Current version TAP/tbs-deps 1.8.0-build.72 / RMQ 1.5.1 / TDS 1.12.0
...
- Need to revisit for WFD wtih 1.8.0-build.72 as it's still using crossplane which uses full RMQ
