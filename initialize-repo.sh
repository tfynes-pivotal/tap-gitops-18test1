...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-18test1
echo     https://github.com/tfynes-pivotal/tap-gitops-18test1
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-18test1 --private
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-18test1
git branch -M main
